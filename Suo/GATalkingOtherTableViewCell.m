...
@interface GATalkingOtherTableViewCell ()
...
@implementation GATalkingOtherTableViewCell
...
- (void)setUI {
    ...
    self.talkingLabel.text = @"敌方兰陵王正在大杀特杀！敌方兰陵王正在大杀特杀！敌方兰陵王正在大杀特杀！敌方兰陵王正在大杀特杀！敌方兰陵王正在大杀特杀！敌方兰陵王正在大杀特杀！";
...
- (void)layoutSubviews {
    ...
    [self.talkingView mas_remakeConstraints:^(MASConstraintMaker *make) {
        ...
        make.right.mas_lessThanOrEqualTo(self.contentView.mas_right).inset(80);
